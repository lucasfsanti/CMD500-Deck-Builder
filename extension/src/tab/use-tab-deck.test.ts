...
describe("useTabDeck (task 2.5)", () => {
  ...
  it("requests all pending cards' enrichment in one batched call and applies results back by id (task 2.3)", async () => {
    mockCapture = {
      status: "ok",
      cards: [
        { id: "a", name: "Sol Ring", quantity: 1, zone: "mainDeck", pageLowestPrice: 4, pageImageUrl: undefined },
        { id: "b", name: "Llanowar Elves", quantity: 1, zone: "mainDeck", pageLowestPrice: 1, pageImageUrl: undefined },
      ],
    };
